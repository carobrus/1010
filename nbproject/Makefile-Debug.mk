...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/1010__2.0_.exe

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/1010__2.0_.exe: ${OBJECTFILES}
	${MKDIR} -p ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/1010__2.0_ ${OBJECTFILES} ${LDLIBSOPTIONS}

${OBJECTDIR}/Backtracking.o: Backtracking.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Backtracking.o Backtracking.cpp
...
${OBJECTDIR}/HeuristicLine.o: HeuristicLine.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/HeuristicLine.o HeuristicLine.cpp

${OBJECTDIR}/HeuristicSurroundingArea.o: HeuristicSurroundingArea.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/HeuristicSurroundingArea.o HeuristicSurroundingArea.cpp
...
${OBJECTDIR}/PrintToConsole.o: PrintToConsole.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/PrintToConsole.o PrintToConsole.cpp
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	...
	${RM} ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/1010__2.0_.exe
