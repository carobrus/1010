...
${OBJECTDIR}/Backtracking.o: Backtracking.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Backtracking.o Backtracking.cpp
...
${OBJECTDIR}/HeuristicHighestScore.o: HeuristicHighestScore.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/HeuristicHighestScore.o HeuristicHighestScore.cpp
